...
if gb_io.gb_number(10) ~= 123456789 then
    error("fail to gb_number")
end

if gb_io.gb_digit(16) ~= 10 then
...
if gb_io.gb_number(16) ~= 0x9ABCDEF then
    error("fail to gb_number")
end
